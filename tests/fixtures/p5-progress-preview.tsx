...
const status:ProcessingStatus=phase==='research'?{phase:'research',message:'Checking published cost evidence for items that need a supported allowance.',currentItems:['First-floor solid-core doors and black hardware','Well installation allowance'] ,updatedAt:new Date().toISOString(),startedAt:new Date(Date.now()-140000).toISOString()}:{phase:'reading',message:'Read 96 of 250 original pages; 12 of 32 sections processed. Checking drawings, schedules and scope.',readPages:96,totalPages:250,readSections:12,totalSections:32,currentItems:['Main-building-plans.pdf (pages 97 to 104 of 250)','Main-building-plans.pdf (pages 105 to 112 of 250)'],updatedAt:new Date().toISOString(),startedAt:new Date(Date.now()-65000).toISOString()};

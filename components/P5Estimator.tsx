...
export function P5Estimator({defaultService='',headingAs='h1',projectSource,layout='embedded',onExit}:P5EstimatorProps){
  ...
  const DELIVERY_LABEL={sent:'Sent',review:'Being checked by our team',pending:'Sending'} as const;
  ...
  const dock=locked&&stage!==2&&stage!==3?<div className={styles.dockHint} role="status">Working on your project. Your progress is saved.</div>
    ...
    :<>{composer}{stage===0&&<p className={styles.dockHint}>Attach plans, photos, inspection reports, Word files or spreadsheets. Tell us things like “price only the trim” or “leave out plumbing” and we will follow them.</p>}</>;

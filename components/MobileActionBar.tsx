...
export default function MobileActionBar(){
  ...
  const mobileActionsVisible=useMobileActionVisibility(path);
  if(!path||/^\/(admin|api|portal|login|quote|estimate)(\/|$)/.test(path))return null;
  return <nav className="p5-mobile-actionbar" data-mobile-nav-bar="" data-mobile-actions-version="2026-09-16.2" style={{display:mobileActionsVisible?undefined:'none'}} aria-label="Quick contact">

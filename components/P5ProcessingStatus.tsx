...
import {processingPresentation,type ProcessingStatus} from '@/lib/p5/processingStatus';
...
export default function P5ProcessingStatus({message,processing,uploadPercent,onPause,hasAttachments}:{message:string;processing?:ProcessingStatus|null;uploadPercent:number|null;onPause?:()=>void;hasAttachments?:boolean}){

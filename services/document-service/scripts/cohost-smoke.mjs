...
try{
 ...
 for(let n=0;n<60;n++){
  ...
  try{const r=await fetch('http://127.0.0.1:5090/api/p5-documents/readyz',{headers:signedHeaders(key,'GET','/readyz',tenant)});if(r.ok){const web=await fetch('http://127.0.0.1:5090/');await web.arrayBuffer();if(web.ok){ready=true;break;}}}catch{}

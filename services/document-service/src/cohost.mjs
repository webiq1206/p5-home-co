...
export function cohostConfig(env=process.env){
 ...
 const workerEnv={...env,PORT:String(workerPort),DOCUMENT_BIND_HOST:'127.0.0.1',DOCUMENT_DATABASE_URL:env.DOCUMENT_DATABASE_URL||env.DATABASE_URL,
  ...
  DOCUMENT_UPLOAD_SLOTS:'1',DOCUMENT_REQUESTS_PER_MINUTE:env.DOCUMENT_REQUESTS_PER_MINUTE||'30',DOCUMENT_TOKENS_PER_MINUTE:env.DOCUMENT_TOKENS_PER_MINUTE||'300000',
   ...
   DOCUMENT_MAX_BYTES:env.DOCUMENT_MAX_BYTES||String(250*1024*1024),DOCUMENT_MAX_PAGES:env.DOCUMENT_MAX_PAGES||'250'};

...
export function readConfig(env=process.env){
 ...
 callMs:integer('DOCUMENT_CALL_TIMEOUT_MS',40000,5000,120000),streamMs:integer('DOCUMENT_STREAM_TIMEOUT_MS',120000,5000,600000),parseMs:integer('DOCUMENT_PARSE_TIMEOUT_MS',60000,5000,180000),jobMs:integer('DOCUMENT_JOB_TIMEOUT_MS',300000,60000,1200000),

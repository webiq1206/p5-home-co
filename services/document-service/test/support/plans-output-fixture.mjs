...
export async function outputFixture({page5Text,page7Text,page8Text}={}){
 ...
 for(let page=1;page<=23;page++){
  const native={page,kind:'drawing',textQuality:1,text:page===5&&page5Text?page5Text:page===7&&page7Text?page7Text:page===8&&page8Text?page8Text:'Synthetic source',spans:[]};

...
const PROPERTIES: PropDef[] = [
  ...
  { name: "p5_gclid", label: "Google Click ID", type: "string", fieldType: "text",
    description: "Google Ads click identifier captured at form entry." },
  { name: "p5_gbraid", label: "Google Braided Click ID", type: "string", fieldType: "text",
    description: "Google Ads iOS click identifier captured at form entry." },
  { name: "p5_wbraid", label: "Google Web Braided Click ID", type: "string", fieldType: "text",
    description: "Google Ads web click identifier captured at form entry." },
  { name: "p5_utm_source", label: "UTM Source", type: "string", fieldType: "text", description: "Latest meaningful UTM source." },
  { name: "p5_utm_medium", label: "UTM Medium", type: "string", fieldType: "text", description: "Latest meaningful UTM medium." },
  { name: "p5_utm_campaign", label: "UTM Campaign", type: "string", fieldType: "text", description: "Latest meaningful UTM campaign." },
  { name: "p5_utm_term", label: "UTM Term", type: "string", fieldType: "text", description: "Latest meaningful UTM term." },
  { name: "p5_utm_content", label: "UTM Content", type: "string", fieldType: "text", description: "Latest meaningful UTM content." },
  { name: "p5_landing_page", label: "Landing Page", type: "string", fieldType: "text", description: "Privacy-safe landing path and campaign parameters." },
  { name: "p5_referrer", label: "Referrer Origin", type: "string", fieldType: "text", description: "External referrer origin only; no path or query." },
  { name: "p5_service", label: "Normalized Service", type: "string", fieldType: "text", description: "Stable quote landing service slug." },

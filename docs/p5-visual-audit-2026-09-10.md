...
## Final scope-route inventory integration

The final main-branch release adds `/estimate/scope` to the recorded route inventory. [Run 34517940578](https://github.com/webiq1206/p5-home-co/actions/runs/34517940578) passed all 126 route/viewport checks across 14 routes, all 15 collected internal links, and nine scope-intake workflow scenarios at application revision `67d8a1e4f82c67a4f1744807f6d534ef8227fdbc`. The CSV now reflects this complete 14-route inventory. The interaction JSON retains the earlier mobile navigation evidence and adds the latest nine-width scope results. Public application code is unchanged by this documentation update.

/**
 * Needs Your Attention: the lead manager board.
 *
 ...
 *
 * This board used to be /admin itself. It moved here when /admin became the
 * dashboard; the header and section menu are now shared with every other
 * section through AdminChrome.
 */
...
export default async function LeadManagerBoard() {
  ...
  return (
    <>
      <AdminChrome user={user} active="leads" subtitle="Lead manager" />
